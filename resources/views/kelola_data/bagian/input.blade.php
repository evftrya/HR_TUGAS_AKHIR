...
@section('content-base')
    <x-form route="{{ route('manage.bagian.create') }}" id="bagian-input">
        <div class="grid gap-8">
            <div class="flex flex-col gap-4">
                ...
                <x-islc lbl="Tipe Bagian" nm="type_work_position" :req="true">
                    ...
                    <option value="Bagian" @selected(old('type_work_position') == 'Bagian')>Bagian</option>
                    <option value="Direktorat" @selected(old('type_work_position') == 'Direktorat')>Direktorat</option>
                    {{-- <option value="Program Studi" @selected(old('type_work_position') == 'Program Studi')>Program Studi</option> --}}
                    <option value="Fakultas" @selected(old('type_work_position') == 'Fakultas')>Fakultas</option>
                </x-islc>
                ...
                <x-islc lbl="Tipe Pekerja yang Biasa Bekerja Disini" nm="type_pekerja" :req="true">
                    ...
                    <option value="Dosen" @selected(old('type_pekerja') == 'Dosen')>Dosen</option>
                    <option value="Tpa" @selected(old('type_pekerja') == 'TPA')>TPA</option>
                    <option value="Both" @selected(old('type_pekerja') == 'Keduanya')>Keduanya</option>
                </x-islc>
