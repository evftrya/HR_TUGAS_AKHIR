    ...
    <div class="relative mx-auto px-4 py-12 font-sans rounded-xl shadow-lg overflow-hidden" style="background: #6176CC;">
        ...
        <div class="relative z-10">
            <div class="mb-12 text-center">
                <h3 class="text-2xl font-bold text-white">Riwayat Dokumen Kepegawaian</h3>
                <p class="mt-2 text-sm text-blue-100">Kronologi Surat Keputusan (SK) dan Amandemen Kontrak Kerja pegawai.</p>
            </div>
                        ...
                        <div class="relative w-full md:flex {{ $loop->iteration % 2 == 1 ? 'md:justify-end' : 'md:justify-start' }}">
                            ...
                            <div class="ml-16 w-[calc(100%-4rem)] md:ml-0 md:w-5/12">
                                <div
                                    ...
                                    <span class="mb-3 block text-sm font-semibold text-gray-400">{{$sk->tmt_mulai}}</span>
                                    <div>
                                        <span
                                    ...
                                    <div class="mb-3 mt-3 text-sm font-medium text-gray-500">No: {{$sk->no_sk}}</div>
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('manage.sk.view',['id_sk_or_sk_number'=>$sk->id]) }}"
                                            class="inline-block rounded bg-blue-600 px-4 py-2 text-xs font-medium text-white hover:bg-blue-700">View Document</a>
                                    </div>
                                </div>
                            </div>
                        </div>
