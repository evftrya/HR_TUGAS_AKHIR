                ...
                <div
                    ...
                    <div class="mb-6 flex items-center justify-between gap-2">
                        ...
                        : route('profile.update-data', ['id_user' => session('account')['id']]) }}"
                                ...
                                class="inline-flex items-center route_pop_up gap-2 rounded-lg bg-gradient-to-b border-blue-200 border-1 px-3.5 py-2 text-xs font-medium text-blue-600 shadow-sm hover:from-blue-500 hover:to-blue-400 hover:text-white active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-200">
                    ...
                    <dl class="grid grid-cols-1 gap-x-8 gap-y-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            @if (isset($user['pegawai_detail']['nip']))
                                <a href="{{ route('manage.sk.view', $user['pegawai_detail']['sk_ypt_or_amandemen']) }}" title="File SK NIDN"
...
@include('kelola_data.pegawai.js.admin-and-nonadmin')
<script>
