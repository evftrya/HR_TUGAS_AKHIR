...
<div class="container-fluid py-4">
    <div class="mx-auto" style="max-width: 980px;">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                <div class="d-flex gap-3">
                    <span class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary-subtle text-primary border border-primary-subtle"
                    ...
                    <div class="w-100">
                        ...
                        <div class="alert alert-light border mt-3 mb-0">
                            ...
                            <ul class="list-unstyled mb-0 space-y-1 text-muted">
                                ...
                                <li class="d-flex gap-2"><span class="text-primary">•</span> Pastikan format data sesuai</li>
                                <li class="d-flex gap-2"><span class="text-primary">•</span> Simpan sebagai <b>.xlsx</b></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        {{-- STEP 2 (FORM) --}}
        <form id="importForm"
              action="{{ route('manage.pegawai.import.validate-file') }}"
              method="POST"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between gap-3 flex-wrap">
                    <div class="d-flex gap-3">
                        <span class="d-inline-flex align-items-center justify-content-center rounded-circle bg-success-subtle text-success border border-success-subtle"
                              style="width:40px;height:40px">
                            ⬆️
                        </span>
                        <div>
                ...
                <div id="dropzone"
                     tabindex="0"
                     class="mt-3 p-4 rounded-4 border border-2 border-dashed bg-body"
                     style="border-style:dashed">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <div class="fw-semibold">Tarik & lepas file di sini</div>
                            <div class="text-muted small">atau klik Pilih File</div>
