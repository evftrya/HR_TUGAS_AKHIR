...
@section('page-name')
    <div class="flex items-center justify-between px-1">
        <div>
            <h2 class="text-2xl font-bold text-[#101828]">Edit Kontrak Manajemen (KM) & Sasaran Mutu (SM)</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <select name="satuan" class="w-full border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl px-4 py-2.5 text-sm transition-all">
                            ...
                            <option value="%" {{ old('satuan', $targetKinerja->satuan) == '%' ? 'selected' : '' }}>%</option>
                            <option value="Orang" {{ old('satuan', $targetKinerja->satuan) == 'Orang' ? 'selected' : '' }}>Orang</option>
                            <option value="Jumlah" {{ old('satuan', $targetKinerja->satuan) == 'Jumlah' ? 'selected' : '' }}>Jumlah</option>
                            <option value="Skor" {{ old('satuan', $targetKinerja->satuan) == 'Skor' ? 'selected' : '' }}>Skor</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <select name="jenis" class="w-full border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl px-4 py-2.5 text-sm transition-all">
                            ...
                            <option value="Kontrak Manajemen" {{ old('jenis', $targetKinerja->jenis) == 'Kontrak Manajemen' ? 'selected' : '' }}>Kontrak Manajemen</option>
                            <option value="Sasaran Mutu" {{ old('jenis', $targetKinerja->jenis) == 'Sasaran Mutu' ? 'selected' : '' }}>Sasaran Mutu</option>
                        </select>
                    </div>
