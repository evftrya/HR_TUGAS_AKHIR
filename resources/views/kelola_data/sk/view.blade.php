                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Ahmad Fauzi</p>
            ...
            <div class="lg:col-span-3 self-start sticky top-10">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div class="w-full rounded-xl overflow-hidden border border-gray-200 bg-gray-100 flex justify-center">
                        ...
                        <iframe
                            src="http://127.0.0.1:5500/public/storage/SK/Pengawakan/Pengawakan_LLDIKTI_62914852704719_daftar%20proses%20sertif%20anggota%20himse.pdf"
