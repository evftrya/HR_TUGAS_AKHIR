            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="satuan" required class="w-full text-sm text-gray-900 border-gray-300 rounded-md shadow-sm focus:ring-blue-500">
                        ...
                        <option value="%" {{ old('satuan', $targetKinerja->satuan) == '%' ? 'selected' : '' }}>Persentase (%)</option>
                        <option value="Orang" {{ old('satuan', $targetKinerja->satuan) == 'Orang' ? 'selected' : '' }}>Orang</option>
                        <option value="Jumlah" {{ old('satuan', $targetKinerja->satuan) == 'Jumlah' ? 'selected' : '' }}>Jumlah / Dokumen</option>
                        <option value="Skor" {{ old('satuan', $targetKinerja->satuan) == 'Skor' ? 'selected' : '' }}>Skor / Indeks</option>
                    </select>
                </div>
